...
public class UserDetailDisplay {
	...
	// builder
	private UserDetailDisplay(Builder builder) {
	...
	public static class Builder {
		...
		public UserDetailDisplay build() {
			return new UserDetailDisplay(this);
		}

		@Override
		public String toString() {
			return "UserDetailDisplay.Builder{" +
					"number=" + number +
					", userId='" + userId + '\'' +
					", password='" + password + '\'' +
					", userName='" + userName + '\'' +
